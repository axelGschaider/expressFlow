...
public class MobileFormListManagementServlet extends HttpServlet {
	private static final Logger log = Logger
			.getLogger(MobileFormListManagementServlet.class.getName());
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (user != null) {
			...
			if (taskName != null) {
				...
				out.println("<title>expressFlow - Mobile Form List</title>");
				...
				out.println("<script type=\"text/javascript\" src=\"/js/mobileformlist.js?mobileformlistname="
						+ taskName + "\"></script>");
